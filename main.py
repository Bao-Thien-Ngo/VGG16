...
# plotting is used for plotting the confusion matrix
...
train_dataset_path = "C:/Users/ngoth/Documents/UMKC/NWPU-RESISC45/train"
valid_dataset_path = "C:/Users/ngoth/Documents/UMKC/NWPU-RESISC45/valid"
test_dataset_path = "C:/Users/ngoth/Documents/UMKC/NWPU-RESISC45/test"
...
# model.load_state_dict(torch.load("C://Users//ngoth//Documents//UMKC//VGG16//gamma-vgg-final.ckpt"))
...
mat = compute_confusion_matrix(model=model, data_loader=test_loader, device=torch.device('cuda:0'))
